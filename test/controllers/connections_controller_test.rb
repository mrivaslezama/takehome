...
class ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connection" do
    assert_difference("Connection.count") do
      post connections_url, params: { connection: { description: @connection.description, origin: @connection.origin, tag: @connection.tag, type: @connection.type } }
    end
  ...
  test "should update connection" do
    patch connection_url(@connection), params: { connection: { description: @connection.description, origin: @connection.origin, tag: @connection.tag, type: @connection.type } }
